...
<head>
    ...
    <title>Buitenzorg Ourdoor - Login</title>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('dba/assets/vendor/css/pages/page-auth.css') }}" />
    <!-- Helpers -->
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Silahkan masuk ke akun anda dan kelola katalog</p>
